...
(function () {
  ...
  // สร้าง array ที่มีตัวเลขสุ่ม 15 ตัว
  

  function getRandomColor() {
    // สุ่มตัวเลขระหว่าง 0 ถึง 16777215 (หรือ 0xFFFFFF)
    let randomColor = Math.floor(Math.random() * 16777215).toString(16);
    
    // เติม '0' ข้างหน้าให้ครบ 6 หลักหากค่าที่สุ่มมีความยาวน้อยกว่า 6
  ...
  for (let i = 67; i < 83; i++) {
    ...
    for (let i = 0; i < 15; i++) {
        randomArray.push(getRandomNumber(-10, 10));
    }
  
    var color = getRandomColor()
    var json = {
            label: 'Container A00'+i,
            data: randomArray,
            tension: 0,
            fill: true,
