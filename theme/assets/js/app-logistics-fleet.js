...
(function () {
  ...
  mapboxgl.accessToken = 'pk.eyJ1IjoicHJlbWthbW9uIiwiYSI6ImNtMXo2b2FzMDAzNXoyanIyNTN3bXc4c2gifQ.k6SctWeKbFjTY52bcQKZgA';
    ...
    features: [
      {
        ...
        geometry: {
          type: 'Point',
          coordinates: [139.845592, 23.064283]
        }
      },
      {
        type: 'Feature',
        ...
        geometry: {
          type: 'Point',
          coordinates: [138.845592, 25.064283]
        }
      },
      {
        type: 'Feature',
        ...
        geometry: {
          type: 'Point',
          coordinates: [133.845592, 22.064283]
        }
      },
      {
        type: 'Feature',
        ...
        geometry: {
          type: 'Point',
          coordinates: [135.845592, 34.064283]
        }
      }
    ]
  };
  ...
  for (const marker of geojson.features) {
    ...
    el.insertAdjacentHTML(
      ...
      '<img src="' +
        assetsPath +
        'img/illustrations/ship.png" alt="Fleet Car" width="40" class="rounded-3" id="carFleet-' +
